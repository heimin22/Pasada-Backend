...
export const getUserFromJWT = async (authHeader?: string): Promise<{ user: any | null, error: any | null }> => {
    if (!authHeader) {
        return { user: null, error: { message: "No authentication header provided" } };
    }
